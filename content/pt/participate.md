...
Todas as produções enviadas devem ser originais, com os seus próprios direitos de autor e não devem ter sido tornadas públicas anteriormente. A reutilização de elementos para criar um trabalho derivado de outra pessoa é aceite, mas dentro dos limites do razoável e devidamente creditado; o plágio flagrante não tem valor criativo e o conteúdo criado com generação de inteligência artificial não tem qualquer valor criativo para nós.

Ao submeteres a tua produção, pedimos-te para indicar explicitamente as tuas fontes e ferramentas, este informação será mostrada no projector antes da tua obra ser projectada e é fundamental para contextualizar para os espectadores.
